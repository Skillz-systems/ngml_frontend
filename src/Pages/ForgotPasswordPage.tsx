...
const ForgotPasswordPage: React.FC = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-between min-h-screen bg-custom-gradient">
      ...
      <div className="bg-card-color pb-[40px] pl-[18px] pr-[18px] rounded-[50px] w-[95%] sm:w-[600px] shadow-lg mb-8 mx-auto">
        <div className="w-32 h-32 relative top-[-70px] mx-auto">
      <img src={logo} alt="Company Logo" className='rounded-full' />
      </div>
        <h2 className="text-head-color text-[24px] font-Mulish font-bold not-italic leading-[100%] text-center">FORGOT PASSWORD</h2>
        <TextInput
          type="text"
          label="Email"
          value={email}
