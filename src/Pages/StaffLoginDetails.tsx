    ...
    <div className='w-[100%] h-screen' style={{ background: 'linear-gradient(108deg, #AAE4C5 -6.77%, #EFEC80 45.65%, #D2F69E 108.92%)', display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
      <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', flexDirection: 'column' }}>
        <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
          <div>
            <div className='sm:w-[100%]' style={{ background: 'rgba(255, 255, 255, 0.50)', width: '560px', padding: 'var(--get-general-numbers-00732, 32px)', borderRadius: 'var(--get-general-numbers-00732, 32px)', position: 'relative', height: '369px' }}>
              <form
                ...
                <div className='flex flex-col items-center justify-center w-full space-y-4 '>
                  <div>
                    <TextInput
                      ...
                      icon={<img src={emailIcon} className='p-0.5 absolute top-0.5 left-0.5' width={24} height={24} alt='business' />}
                      iconHeight='24px'
                      iconWidth='24px'
                  ...
                  <div>
                    <TextInput
                      ...
                      error={false}
                      onChange={handleOnChange}
                      icon={<img src={lockIcon} className='p-0.5 absolute top-0.5 left-0.5' width={24} height={24} alt='lock' />}
                      iconRight={<img src={eyeIcon} className='p-0.5 absolute top-3' alt='showpassword' />}
                      iconHeight='24px'
                      iconWidth='24px'
                      backgroundColor='#D2F69E'
                      iconStyle='absolute top-3 left-2  rounded-full'
                ...
                <div style={{ color: '#49526A', fontFamily: 'Mulish', fontSize: '16px', fontWeight: '500', lineHeight: '40px', fontStyle: 'italic', textDecorationLine: 'underline', cursor: 'pointer' }}>
            ...
            <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', marginTop: '20px' }}>
              <div>
                <div className='w-96 ' style={{ background: 'rgba(255, 255, 255, 0.50)', width: '560px', borderRadius: 'var(--get-general-numbers-00732, 32px)', height: '56px', padding: 'var(--get-general-numbers-00732, 24px)', alignItems: 'center', display: 'flex' }}>
                  <div style={{ alignItems: 'center', justifyContent: 'center', display: 'flex', columnGap: '80px' }}>
                    <div style={{ color: 'var(--TEXT-MAIN, #050505)', fontFamily: 'Mulish', fontSize: '18px', fontWeight: '400', lineHeight: '100%' }}>New to the portal, sign in here</div>
                    <div>
                      <ButtonComponent
