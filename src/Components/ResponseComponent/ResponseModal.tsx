...
const ResponseModal: React.FC<ResponseModalProps> = ({
  ...
  <div className='w-[100%] h-screen' style={{ backgroundColor: '#f5f5eb', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
    ...
    {type === 'error' &&
      <div style={{ width: '180px', height: '180px', borderRadius: '100%', backgroundColor: '#FFFDF7', display: 'flex', alignItems: 'center', justifyContent: 'center', position: 'absolute', left: '45%', top: '240px', zIndex: 100000 }}>
      <div style={{ width: '150px', height: '150px', borderRadius: '100%', backgroundColor: '#FEF8E6', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
        <div style={{ width: '120px', height: '120px', borderRadius: '100%', backgroundColor: '#FFF3D5', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
          <img src={Deleteicon} alt='Deleteicon' style={{ height: '60px', width: '60px' }} />
        </div>
      </div>
    </div>}
      <div style={{ position: 'relative' }}>
        <div style={{ height, width, backgroundColor, boxShadow: '#0000000D', borderTopLeftRadius: '20px', borderTopRightRadius: '20px', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
        {type === 'success' && <div style={{ marginTop: '60px' }}>
         ...
         {type === 'error' && <div style={{ marginTop: '67px', marginBottom: '20px' }}>
            <div style={{ fontWeight: '700', fontSize: '32px', lineHeight: '32px', color: '#49526A' }}>Are you sure you want to cancel?</div>
            <div style={{ fontWeight: '500', fontSize: '16px', lineHeight: '32px', letterSpacing: '0.8%', color: '#828DA9' }}>All changes will be lost</div>
         </div>}
        </div>
       <div>
       <div style={{ position: 'absolute', left: '45%', top: '210px', zIndex: 100000 }}>
        ...
        {type === 'success' && <div style={{ height: '120px', width: '500px', backgroundColor: '#00AF50', boxShadow: '#0000000D', borderBottomRightRadius: '20px', borderBottomLeftRadius: '20px', bottom: '50px', display: 'flex', alignItems: 'center', justifyContent: 'center', position: 'relative' }}>
          <div>
            <ButtonComponent
       ...
       {type === 'error' && <div style={{ height: '120px', width: '500px', backgroundColor: '#FF0000', boxShadow: '#0000000D', borderBottomRightRadius: '20px', borderBottomLeftRadius: '20px', bottom: '50px', alignItems: 'center', justifyContent: 'center', position: 'relative', display: 'flex' }}>
