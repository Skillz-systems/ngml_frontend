...
const SummaryInformation: React.FC = () => {
  return (

    <div className="w-full h-screen p-4 bg-blue-500 rounded-xl flex-col justify-start items-start gap-6 inline-flex border border-yellow-400">
      <div className="w-full h-full relative bg-white border-2 border-green-400">
        <div className="flex-col justify-center items-center gap-2 inline-flex">
          <div className="w-16 h-16 rounded-full justify-center items-center inline-flex">
            <img className="w-full h-full" src={CompanyLogo} />
          </div>
        ...
        {/* <div className="p-[15.17px] left-[327.50px] top-[1224.67px] absolute justify-center items-center gap-[15.17px] inline-flex border-indigo-400">
          <div className="text-center text-neutral-400 text-base font-medium font-['Red Hat Display'] pt-20">Powered by Skillz</div>
        </div> */}
        <div className="p-5  rounded-lg border border-gray-200 flex-col justify-start items-start gap-4 inline-flex ">
          <div className="w-full justify-between items-start inline-flex">
            <div className="h-fit px-5 py-2.5 bg-green-600 rounded justify-start items-center gap-2.5 flex">
              <div className="text-white text-base font-bold font-['Mulish']">Personal Information</div>
            </div>
          </div>
          <div className="w-full justify-between items-start inline-flex">
            <div className="h-32 justify-between items-start flex">
              <img className="w-32 h-32 rounded" src={guy} />
              <div className="w-56 flex-col justify-start items-start gap-0.5 inline-flex">
                <div className="flex-col justify-center items-start gap-1 flex">
                  <div className="w-56 pl-1 py-1 bg-slate-50 rounded justify-start items-center gap-2.5 inline-flex">
                    <div className="w-24 text-slate-400 text-xs font-bold font-['Mulish'] uppercase pr-12">Title:</div>
                  </div>
          ...
          <div className="w-full px-5 py-2.5 bg-green-600 rounded justify-start items-center gap-2.5 inline-flex">
          ...
          <div className="px-1 flex-col justify-start items-start gap-1 flex">
            <div className="w-fit justify-start items-start gap-20 inline-flex bg-emerald-600">
              <div className="w-32 flex-col justify-start items-start inline-flex">
                <div className="w-96 h-8 justify-start items-center gap-6 inline-flex">
                  <div className="text-slate-400 text-sm font-normal font-['Mulish']">Verification No:</div>
                </div>
                <div className="w-96 h-6 justify-start items-center gap-6 inline-flex">
              ...
              <div className="w-32 flex-col justify-start items-start inline-flex">
                <div className="w-32 h-[33px] justify-start items-center gap-[25px] inline-flex">
                  <div className="text-slate-400 text-sm font-normal font-['Mulish']">Captured By:</div>
                </div>
                <div className="w-32 h-[22px] justify-start items-center gap-[25px] inline-flex">
                  <div className="text-zinc-950 text-sm font-bold font-['Mulish']">N/A</div>
                </div>
              </div>
            </div>
          ...
          <div className="w-full px-[19px] py-2.5 bg-green-600 rounded justify-start items-center gap-2.5 inline-flex">
          ...
          <div className="w-full justify-between items-center grid grid-cols-2 gap-4">
            <div className="px-4 py-2.5 bg-green-600 rounded justify-start items-center gap-2.5 flex">
